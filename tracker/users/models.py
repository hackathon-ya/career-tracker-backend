...
class Candidate(AbstractUser):
    ...
    active = models.BooleanField(verbose_name="Активный пользователь", null=True, blank=True,)
    last_activity = models.DateTimeField(verbose_name="Был активен", null=True, blank=True,)
    experience_months = models.IntegerField(verbose_name="Опыт работы", null=True, blank=True,)
    ...
    resume = models.FileField(upload_to="resumes/", verbose_name="Резюме", null=True, blank=True,)
    skills = models.ManyToManyField(
        Skills, related_name="candidate_skills", verbose_name="Навыки",
    )
    mobile = models.CharField(max_length=16, verbose_name="Телефон", null=True, blank=True,)
    telegram = models.CharField(max_length=255, verbose_name="Телеграм", null=True, blank=True,)
    pub_date = models.DateTimeField(auto_now_add=True, verbose_name="Дата размещения", null=True, blank=True,)

    groups = models.ManyToManyField(Group, related_name='candidate_groups')
    user_permissions = models.ManyToManyField(Permission, related_name='candidate_user_permissions')
